...
def home(request):
    ...
    demandobjs = demandobjs.up_to_date()
    offerobjs = offerobjs.up_to_date()
...
def user_profile(request, user_id):
    ...
    if user.is_authenticated():
        ...
        if in_other_ignore_list and not request.user.is_superuser :
            messages.add_message(request, messages.INFO, _('Vous êtes pas autorisé à consulter ce profil'))
            return redirect('home')
...
# ========================
# |Begin|FRAMEWORK:Monnaie
# ========================



# ======================
# |End|FRAMEWORK:Monnaie
# ======================
