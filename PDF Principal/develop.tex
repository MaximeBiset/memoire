...
Après avoir développé un premier feature simple,  nous pouvons entreprendre de mettre en place le feature des objets.  L'objectif de ce feature est de pouvoir échanger des objets matériels en plus des échanges de services.  Cette fonctionnalité étant assez transversale à l'application,  nous allons lister quelques points clés et difficultés rencontrés lors du développement.  Nous allons en profiter pour souligner l'utilisation ou non de techniques liées au développement d'un framework tels que les design patterns et autres.
