...
\vspace{0.5cm}
\fbox{\includegraphics[scale=0.30]{gr8home1.png}}
\vspace{0.5cm}
...
\vspace{1cm}
\fbox{\includegraphics[scale=0.30]{gr8inscr.png}}
\vspace{1cm}
...
\vspace{1cm}
\fbox{\includegraphics[scale=0.30]{gr8profil.png}}
\vspace{1cm}
...
\vspace{1cm}
\fbox{\includegraphics[scale=0.30]{gr8home.png}}
\vspace{1cm}
...
\vspace{1cm}
\fbox{\includegraphics[scale=0.30]{encoder.png}}
\vspace{1cm}
